...
#endif
//raspberry pi, retroflag gpi case 2w
#if 0
    switch(key){
      case /*B*/305:     key = SDLK_UP;      break; /* vkUP    */
      case /*A*/304:   key = SDLK_DOWN;    break; /* vkDOWN  */
      case /*Y*/308:   key = SDLK_LCTRL;   break; /* vkLEFT  */
      case /*X*/307:  key = SDLK_RETURN;  break; /* vkRIGHT */
      case /*START*/315:    key = SDLK_q;       break; /* vkStart */
      case /*SELECT*/314:    key = SDLK_RETURN;  break; /* vkA     */
      case /*L*/310:    key = SDLK_SPACE;   break; /* vkB     */
      case /*R*/311:    key = SDLK_ESCAPE;  break; /* vkC     */
      default: break;
    }
#else
//not effect for gpicase
    key = SDLK_RETURN;
#endif    
    return key;
}
